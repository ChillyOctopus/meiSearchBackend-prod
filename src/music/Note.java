...
public class Note {
     ...
     */
    public Float getDurationRation(Note n){return (n.getDuration() / this.getDuration());}
    ...
    public Note applyAccidental(String accidental){
        ...
        if(difference > 10) return new Note(this.pitch.charAt(0), accidental, this.octave-1, this.duration);
    ...
    public boolean equals(Object obj) {
        ...
        return (this.getPitchPos() == compMe.getPitchPos() &&
                this.getDuration() == compMe.getDuration());
